...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AluCost Salta — Presupuestos para carpinterías de aluminio" },
      { name: "description", content: "Calculá presupuestos de aberturas de aluminio en segundos. Precios actualizados de proveedores de Salta." },
    ],
    links: [
